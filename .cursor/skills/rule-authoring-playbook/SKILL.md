...
description: Create, review, or refactor AI rule files for Cursor, GitHub Copilot, and related ecosystems. Use for rule scope design, precedence and conflict control, concise rule wording, and testable rule behavior.
---
