...
description: Author, review, or refactor SKILL.md guidance for reusable AI agent skills. Use for scope design, trigger calibration, safety boundaries, and quality validation of skill authoring artifacts.
---
