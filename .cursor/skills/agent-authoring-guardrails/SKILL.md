...
description: Create, review, or refactor AI agent guidance files such as SKILL.md, copilot-instructions.md, and rule files under .rulesync/. Use for instruction quality, trigger boundaries, safety constraints, and testable wording.
---
