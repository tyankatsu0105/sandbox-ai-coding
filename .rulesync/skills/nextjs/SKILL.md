...
name: nextjs
description: >-
  Next.js 16 (this project) has breaking API and convention changes from
  prior versions. Use when writing, editing, or reviewing any Next.js code —
  pages, layouts, routing, middleware, data fetching, caching, config, or CLI.
  Do NOT rely on training data for Next.js APIs; always consult the bundled docs.
targets: ["*"]
---
