...
- At the very start of each response, list the skills and rules consulted (e.g., "Referenced: agent-response-behavior rule"). If none were consulted, write "Referenced: none".
